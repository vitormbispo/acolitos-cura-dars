...
export class LineupGroup{
    ...
    public get lineups(): Array<Lineup> { return this._lineups; }
    public set lineups(value: Array<Lineup>) { this._lineups = value; }
    public get places(): Array<string> { return this._places; }
    public set places(value: Array<string>) { this._places = value; }
    public get type(): MemberType { return this._type; }
    public set type(value: MemberType) { this._type = value; }
    public get monthLineupsMap(): object { return this._monthLineupsMap; }
    public set monthLineupsMap(value: object) { this._monthLineupsMap = value; }
}