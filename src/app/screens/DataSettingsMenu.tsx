...
export default function DataSettingsMenu(){
    ...
    return(
        <View style={{flex:1}}>
            ...
            <RowImageButton img={ICONS.export} text={"Exportar dados"} press={()=>{
                router.push("/screens/DataExport")
            }}/>
            <RowImageButton img={ICONS.import} text={"Importar dados"} press={()=>{
                LoadDataFile()
            }}/>
            <RowImageButton img={ICONS.erase_data} text={"Excluir dados"} press={()=>{
                router.push("/screens/DataErase")
            }}/>
