 ...
 */
export const ICONS = {
    home:require("@/src/app/item_icons/homeV1_ico.png"),
    acolito:require("@/src/app/item_icons/acolito_ico.png"),
    coroinha:require("@/src/app/item_icons/coroinha_ico.png"),
    edit:require("@/src/app/item_icons/edit_ico.png"),
    escala:require("@/src/app/item_icons/escalas_ico.png"),
    add_acolito:require("@/src/app/item_icons/add_acolito_ico.png"),
    add_coroinha:require("@/src/app/item_icons/add_coroinha_ico.png"),
